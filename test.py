...
pyraminx.rotate_front_rows(True, 4)
# print(pyraminx.red_tiles[3][0].move_stack)
# print(pyraminx.blue_tiles[3][0].move_stack)
# print(pyraminx.yellow_tiles[3][0].move_stack)
# print(pyraminx.green_tiles[0][0].move_stack)

for row in pyraminx.green_tiles:
    for tile in row:
        print(tile.move_stack)
